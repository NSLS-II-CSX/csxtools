...
#
# $Id: fit.py 229 2012-01-29 21:52:35Z stuwilkins $
...
__id__        = "$Id: fit.py 229 2012-01-29 21:52:35Z stuwilkins $"
...
##
    ...
    def chiSquared(self, norm = True, dist = 'poisson'):
        ...
        N = len(self._datax)
        if ndim(self._datax) > 2:
            N = len(self._datax[0]) * len(self._datax[1])
        P = len(self.result)
        self.chi2 = pow( (self._evalfunc() - self._datay) / (0.01*self._datay), 2)
