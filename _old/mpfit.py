...
class mpfit:
	...
	statusNiceText = { 0 : 'Improper input parameters',
                       1 : 'GOOD FIT : Both actual and predicted relative reductions in the sum of squares are at most ftol',
  ...
  Keywords:
   ...
   Outputs:
	...
	def qrsolv(self, r, ipvt, diag, qtb, sdiag):
		...
		#x[ipvt] =wa
                x_temp = numpy.zeros(len(ipvt))
                for idx, ip in enumerate(ipvt):
                    x_temp[ip] = wa[idx]
		return (r, x_temp, sdiag)
